...
WHERE (SAFETY_CARDS.DEPT_ID In ('MWAL','MWSA', 'MWEGL')) AND (SAFETY_CARDS.EMPLOYEE_STATUS_CODE='01') AND (SAFETY_CARDS.EMPLOYEE_TYPE_CODE='B') AND (SAFETY_CARDS.SUPERVISOR_IND='Y') AND (SAFETY_CARDS.MANAGER_TYPE_ID=5)
...
AND ((SAFETY_CARDS.DEPT_ID In ('MWAL','MWSA', 'MWEGL')) 
AND (SAFETY_CARDS.EMPLOYEE_STATUS_CODE='01') 
AND (SAFETY_CARDS.EMPLOYEE_TYPE_CODE='B') 
AND (SAFETY_CARDS.SUPERVISOR_IND='Y') 
AND (SAFETY_CARDS.MANAGER_TYPE_ID=5) 
...
you = ["chris.schottmiller@aksteel.com", "Sal.Ciriello@aksteel.com", "Greg.Robertson@aksteel.com", "Glenn.Stamper@aksteel.com", "Eric.Lawson@aksteel.com", "Rick.Laird@aksteel.com", "TonyL.Webb@aksteel.com", "Gary.Larason@aksteel.com", "Bruce.Blair@aksteel.com", "Jeremy.Fudge@aksteel.com", "Ken.Becknell@aksteel.com", "Luke.Resczynski@aksteel.com", "Jack.Totten@aksteel.com", "Michael.Rossman@aksteel.com", "Casey.Tannreuther@aksteel.com", "Jonathan.Aarons@aksteel.com"]
#you = ["chris.schottmiller@aksteel.com", "TonyL.Webb@aksteel.com"]
...
next_week_emails = []
alum_emails = ["chris.schottmiller@aksteel.com", "TonyL.Webb@aksteel.com", "Glenn.Stamper@aksteel.com"]
eg_emails = ["chris.schottmiller@aksteel.com", "chester.robinson@aksteel.com", "TonyL.Webb@aksteel.com"]
next_week_emails.append(alum_emails)
next_week_emails.append(eg_emails)
