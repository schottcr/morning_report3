...
you = ["chris.schottmiller@aksteel.com", "Dale.Pack@aksteel.com", "Richard.Oswald@aksteel.com", "Craig.Slama@aksteel.com", "Genayee.Richards@aksteel.com", "Bob.Nusekabel@aksteel.com", "John.Vanhoose@aksteel.com", "Kevin.Vincent@aksteel.com", "Angela.Forrester@aksteel.com", "Chris.Slicker@aksteel.com", "Michael.Hawkins@aksteel.com"]
...
for idx, next_weekly_list in enumerate(next_weekly_lists):
    ...
    if all([len(daily_alerts) > 0, datetime.datetime.today().isoweekday() >= 1]):
        ...
        you = ["chris.schottmiller@aksteel.com", "Dale.Pack@aksteel.com", "Richard.Oswald@aksteel.com",
               ...
               "John.Vanhoose@aksteel.com", "Kevin.Vincent@aksteel.com", "Angela.Forrester@aksteel.com", "Chris.Slicker@aksteel.com", "Michael.Hawkins@aksteel.com"]
        # Create message container - the correct MIME type is multipart/alternative.
        msg = MIMEMultipart('alternative')
