...
WHERE (SAFETY_CARDS.DEPT_ID In ('MWCMMGMT')) AND (SAFETY_CARDS.EMPLOYEE_STATUS_CODE='01') AND (SAFETY_CARDS.EMPLOYEE_TYPE_CODE In ('B', 'C'))  AND (SAFETY_CARDS.MANAGER_TYPE_ID In (5, 8))
...
AND ((SAFETY_CARDS.DEPT_ID In ('MWCMMGMT')) 
...
you = ["chris.schottmiller@aksteel.com", "Dale.Pack@aksteel.com", "Richard.Oswald@aksteel.com", "Craig.Slama@aksteel.com", "Genayee.Richards@aksteel.com", "Bob.Nusekabel@aksteel.com", "John.Vanhoose@aksteel.com", "Kevin.Vincent@aksteel.com", "Angela.Forrester@aksteel.com", "Chris.Slicker@aksteel.com"]
...
for idx, next_weekly_list in enumerate(next_weekly_lists):
    ...
    if all([len(daily_alerts) > 0, datetime.datetime.today().isoweekday() >= 1]):
        ...
        # you == recipient's email address
        me = "chris.schottmiller@aksteel.com"
        you = ["chris.schottmiller@aksteel.com", "Dale.Pack@aksteel.com", "Richard.Oswald@aksteel.com",
               "Craig.Slama@aksteel.com", "Genayee.Richards@aksteel.com", "Bob.Nusekabel@aksteel.com",
               "John.Vanhoose@aksteel.com", "Kevin.Vincent@aksteel.com", "Angela.Forrester@aksteel.com", "Chris.Slicker@aksteel.com"]
        # Create message container - the correct MIME type is multipart/alternative.
        msg = MIMEMultipart('alternative')
